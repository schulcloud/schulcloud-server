...
const removeManyCourses = (ids) => courseModel
    .deleteMany({ _id: { $in: ids } })
    .lean()
    .exec();
const createTestCourse = (appPromise, opt) => async ({ 
// required fields for base group
name = 'testCourse', schoolId = opt.schoolId, userIds = [], classIds = [], teacherIds = [], ltiToolIds = [], substitutionIds = [], features = [], startDate, untilDate, } = {}) => {
