...
const removeManyProviders = (ids) => StorageProviderModel.deleteMany({ _id: { $in: ids } })
    .lean()
    .exec();
const createTestProvider = (appPromise) => async ({ 
// required fields for base group
type = 'S3', isShared = true, accessKeyId = '123456789', secretAccessKey = '123456789', endpointUrl = 'http://example.org', region = 'eu-de', maxBuckets = 200, freeBuckets = 200, } = {}) => {
...
//# sourceMappingURL=storageProviders.js.map