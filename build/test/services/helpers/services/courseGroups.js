...
const removeManyCourses = (ids) => courseGroupModel
    .deleteMany({ _id: { $in: ids } })
    .lean()
    .exec();
const createTestCourseGroup = (app, opt) => ({ 
// required fields for base group
name = 'testCourse', schoolId = opt.schoolId, userIds = [], classIds = [], courseId = undefined, } = {}) => courseGroupModel
    .create({
...
//# sourceMappingURL=courseGroups.js.map