...
const removeManyClasses = (ids) => classModel
...
// required fields
name = 'testClass', schoolId = opt.schoolId, userIds = [], teacherIds = [], nameFormat = 'static', gradeLevel = undefined, year = undefined, predecessor = undefined, }) => {
