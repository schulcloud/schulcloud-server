...
module.exports = (app, opt = { schoolId: '5f2987e020834114b8efd6f8' }) => {
    const { accounts, activation, classes, consents, consentVersion, courses, courseGroups, roles, schools, years, schoolGroups, datasources, files, homeworks, lessons, login, ltiTools, pseudonyms, storageProviders, submissions, teams, testSystem, users, } = serviceHelpers(app, opt);
