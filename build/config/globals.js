...
const globals = {
    ...
    MAXIMUM_ALLOWABLE_TOTAL_ATTACHMENTS_SIZE_BYTE: 5 * 1024 * 1024,
    ...
    LOGIN_BLOCK_TIME: process.env.LOGIN_BLOCK_TIME || 15,
    ...
    FILE_SECURITY_CHECK_MAX_FILE_SIZE: parseInt(process.env.FILE_SECURITY_CHECK_MAX_FILE_SIZE || '', 10) || 512 * 1024 * 1024,
