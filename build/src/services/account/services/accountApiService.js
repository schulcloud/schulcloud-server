...
const { hasPermission, permitGroupOperation, restrictToCurrentSchool, preventPopulate, getRestrictPopulatesHook, } = require('../../../hooks');
const { sanitizeUsername, validateCredentials, trimPassword, validatePassword, checkUnique, removePassword, restrictAccess, checkExistence, protectUserId, securePatching, 
// filterToRelated,
restrictToUsersSchool, validateUserName, restrictToSameSchool, } = require('../hooks');
...
//# sourceMappingURL=accountApiService.js.map