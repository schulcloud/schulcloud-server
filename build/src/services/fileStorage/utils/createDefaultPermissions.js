...
const addCourseDefaultPermissions = async (permissions, studentCanEdit) => {
    ...
    permissions.push(createPermission(studentRoleId, 'role', {
        write: Boolean(studentCanEdit),
        create: false,
        delete: false,
    }));
    permissions.push(createPermission(teacherRoleId, 'role', {
        create: false,
        delete: false,
    }));
    return permissions;
 ...
 */
const createDefaultPermissions = async (userId, type = 'user', { studentCanEdit, sendPermissions = [], owner } = { sendPermissions: [] }) => {
...
//# sourceMappingURL=createDefaultPermissions.js.map