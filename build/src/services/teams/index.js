...
const { getBasic, extractOne, getTeam, patchTeam, getSessionUser, removeInvitedUserByEmail, getUpdatedSchoolIdArray, } = require('./helpers');
...
class Add {
    ...
    async _userImportByEmail(teamId, { email, role }, params) {
        ...
        const { esid, isUserCreated, isResend, user, team, userRoleName, importHash, } = await this._collectUserAndLinkData({ email, role, teamId });
