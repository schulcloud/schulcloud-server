...
const { verifyToken, decryptToken, createUserAndAccount, shortenedRegistrationProcess, findSchool, ENTITY_SOURCE, SOURCE_ID_ATTRIBUTE, config: TSP_CONFIG, } = require('../../sync/strategies/TSP/TSP');
...
class TSPStrategy extends AuthenticationBaseStrategy {
    ...
    async authenticate(authentication, params) {
        ...
        if (!user) {
            ...
            user = await createUserAndAccount(app, {
...
//# sourceMappingURL=TSPStrategy.js.map