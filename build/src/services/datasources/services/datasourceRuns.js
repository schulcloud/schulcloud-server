...
class DatasourceRuns {
    ...
    async create(data, params) {
        ...
        promise.catch(async (err) => {
            ...
            throw new GeneralError('datasourceRun encountered an error after invoking sync. This is most likely a user error.', err);
        });
...
//# sourceMappingURL=datasourceRuns.js.map