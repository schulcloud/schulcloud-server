...
const { validPassword, blockThirdParty, validateEmail, blockDisposableEmail, trimPassword, hasPermission, checkUniqueAccount, } = require('../../hooks/utils');
const { STATE, KEYWORDS: { E_MAIL_ADDRESS }, sendMail, getUser, deleteEntry, createEntry, setEntryState, createActivationLink, Mail, BadRequest, Forbidden, GeneralError, customErrorMessages, } = require('../../utils/generalUtils');
