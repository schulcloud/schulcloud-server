...
const { hasPermission, } = require('../../hooks/utils');
const { STATE, KEYWORDS: { E_MAIL_ADDRESS }, // <--- set keyword here
getUser, createEntry, setEntryState, BadRequest, } = require('../../utils/generalUtils'); // <--- basic building blocks (also include keywords from customStrategyUtils)
