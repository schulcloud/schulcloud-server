...
class LessonCopyService {
    ...
    async copyFilesInLesson(params, sourceLesson, newCourseId, newLesson) {
        ...
        const lessonFiles = files.filter((f) => _.some(sourceLesson.contents || [], (content) => content.component === 'text' && content.content.text && _.includes(content.content.text, f._id.toString())));
...
//# sourceMappingURL=LessonCopyService.js.map