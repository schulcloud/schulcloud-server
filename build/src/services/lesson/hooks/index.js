...
const { injectUserId, hasPermission, ifNotLocal, permitGroupOperation, checkCorrectCourseOrTeamId, getRestrictPopulatesHook, preventPopulate, } = require('../../../hooks');
...
const restrictToUsersCoursesLessons = async (context) => {
    ...
    if (context.method === 'find') {
        if (context.params.query.shareToken)
            return context;
    ...
    if (courseGroup)
        studentsWithAccess = courseGroup.userIds;
