...
const getUserData = (userId) => userModel
    .findOne({ _id: userId }, {
    _id: 1,
    firstName: 1,
    lastName: 1,
    ...
    .lean()
    .exec();
const getCourseData = (courseId) => courseModel
    ...
    .lean()
    .exec();
const getTeamData = (teamId) => teamsModel
    .findOne({ _id: teamId }, {
    _id: 1,
    schoolId: 1,
    name: 1,
    ...
    .lean()
    .exec();
const getSchoolData = (schoolId) => schoolModel
    ...
    .lean()
    .exec();
const getAllCourseDataForUser = (userId) => courseModel
    .find({
    ...
    .lean()
    .exec();
const getAllTeamsDataForUser = (userId) => teamsModel.find({ userIds: { $elemMatch: { userId } } }, {
    _id: 1,
    name: 1,
    userIds: 1,
    features: 1,
