...
function obtainAccessToken(userId, homeserverApiUri, secret) {
    ...
    return request(options).then((response) => {
        const homeserverUrl = response.well_known && response.well_known['m.homeserver'] && response.well_known['m.homeserver'].base_url
...
//# sourceMappingURL=messengerTokenService.js.map