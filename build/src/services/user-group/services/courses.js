...
const { ifNotLocal, restrictToCurrentSchool, restrictToUsersOwnCourses, hasPermission, getRestrictPopulatesHook, mapPaginationQuery, permitGroupOperation, addCollation, preventPopulate, injectUserId, denyIfNotCurrentSchool, } = require('../../../hooks');
...
const { addWholeClassToCourse, deleteWholeClassFromCourse, courseInviteHook, patchPermissionHook, restrictChangesToArchivedCourse, removeSubstitutionDuplicates, } = require('../hooks/courses');
...
const courseHooks = {
    ...
    after: {
        ...
        find: [],
        get: [
            ifNotLocal(denyIfNotCurrentSchool({
