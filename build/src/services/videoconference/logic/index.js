 ...
 */
const joinMeeting = (server, meetingName, meetingId, userName, role, params, create = false) => server.monitoring
 ...
 */
exports.getMeetingInfo = (server, meetingId) => server.monitoring.getMeetingInfo(meetingId).then((meeting = {}) => {
    const { response } = meeting;
