...
const { mapPaginationQuery, resolveToIds, restrictToCurrentSchool, permitGroupOperation, denyIfNotCurrentSchool, denyIfStudentTeamCreationNotAllowed, computeProperty, addCollation, blockDisposableEmail, getRestrictPopulatesHook, preventPopulate, } = require('../../../hooks');
const { mapRoleFilterQuery, checkUnique, checkUniqueEmail, checkJwt, checkUniqueAccount, updateAccountUsername, removeStudentFromClasses, removeStudentFromCourses, sanitizeData, pinIsVerified, securePatching, decorateUser, decorateAvatar, decorateUsers, handleClassId, pushRemoveEvent, enforceRoleHierarchyOnDelete, enforceRoleHierarchyOnCreate, filterResult, generateRegistrationLink, sendRegistrationLink, includeOnlySchoolRoles, } = require('../hooks/userService');
