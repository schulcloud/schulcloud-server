...
const userSchema = new Schema({
    ...
    ldapDn: { type: String, index: true },
    ldapId: { type: String, index: true },
...
function buildSearchIndexOnUpdate() {
    ...
    if (data.firstName && !data.firstNameSearchValues)
        data.firstNameSearchValues = splitForSearchIndexes(data.firstName);
    if (data.lastName && !data.lastNameSearchValues)
        data.lastNameSearchValues = splitForSearchIndexes(data.lastName);
    if (data.email && !data.emailSearchValues)
        data.emailSearchValues = splitForSearchIndexes(data.email);
}
